...
def SummarizeAlignmentsParser():
    ...
    parser.add_argument('alignment_type', choices=['barcodedsubamplicons', 'subassemble'], help="The type of alignments that are being summarized. Use 'barcodedsubamplicons' if the alignments were built with 'dms_barcodedsubamplicons'. Use 'subassemble' if the alignments were build with 'dms_subassemble'.")

...
def SimulateLibraryCounts(depths_outfiles, prefs_file, avgmu, avgepsilon, avgrho, mu_concentration=500.0, epsilon_concentration=500.0, rho_concentration=500.0, seed=1):

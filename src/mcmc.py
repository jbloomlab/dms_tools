...
def InferSitePreferences(characterlist, wtchar, error_model, counts, priors, seed=1, niter=10000, n_jobs=1, r_max=1.1, neff_min=100, nchains=4, increasefactor=2, increasetries=6):
...
def InferSiteDiffPrefs(characterlist, wtchar, error_model, counts, priors, seed=1, n_jobs=1, r_max=1.1, neff_min=100, nchains=4, niter=10000, increasefactor=2, increasetries=6):

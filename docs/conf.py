# -*- coding: utf-8 -*-
#
# dms_tools documentation build configuration file, created by
...
htmlhelp_basename = 'dms_toolsdoc'
...
latex_documents = [
  ('index', 'dms_tools.tex', u'dms\\_tools Documentation',
...
man_pages = [
    ('index', 'dms_tools', u'dms_tools Documentation',
     [u'Jesse Bloom'], 1)
]
...
texinfo_documents = [
  ('index', 'dms_tools', u'dms_tools Documentation',
   u'Jesse Bloom', 'dms_tools', 'One line description of project.',
   'Miscellaneous'),
]
